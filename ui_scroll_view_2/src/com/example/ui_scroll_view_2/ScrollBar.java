...
OnClickListener,OnLongClickListener,OnTouchListener,OnCheckedChangeListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String content = "nvestors are worried about India's large current account deficit, which reflects the nation's tendency to import many more goods than it exports and leaves it heavily reliant on foreign capital." +
